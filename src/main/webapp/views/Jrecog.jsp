...
<script language='javascript' type='text/javascript'>
    $(function () {
        var tag = '<%=session.getAttribute("Jtag2")%>';
        if(tag=="1"){
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <img src="${sessionScope.JpageSource}" class="img-responsive" width="200px">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <c:if test="${sessionScope.Jtag2 =='1'}"><label id="state1"><font color="red">识别中</font></label></c:if>
                                <c:if test="${sessionScope.Jtag =='1'}"><label class="state"><font color="red">已识别</font></label></c:if>
                                <c:if test="${sessionScope.Jtag !='1'}"><label class="state"><font color="red">识别中</font></label></c:if>
                                <!-- <input type="text"  size="10px" value="0.875" disabled="disabled"/> -->
                            </div>
                            <div class="row">
                                <label style="margin-left: 40px">电厂名称:</label>
                                <label class="state">${sessionScope.Jname}</label>
                                <!-- <input type="text"  size="10px" value="0.875" disabled="disabled"/> -->
                            </div>
                            <div class="row">
                                <label style="margin-left: 40px">地理位置:</label>
                                <label class="state">${sessionScope.Jlatitude},&nbsp${sessionScope.Jlongtitude}</label>
                                <!-- <input type="text"  size="10px" value="0.875" disabled="disabled"/> -->
                            </div>
                            <div class="row">
                                <label style="margin-left: 40px">预测准确率:</label>
                                <label class="state">${sessionScope.Jrate}</label>
                ...
                <div class="col-md-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <c:if test="${sessionScope.Jtag =='1'}"><img id="state2" src="${sessionScope.JpageRecog}" class="img-responsive" width="200px"></c:if>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-1">
                    <div class="text-center">
                        <a href="../JgoFront.do"><button id="targetimage1" class="btn btn-primary" >前一张</button></a>
                    </div>
                </div>
                <div class="col-md-1"></div>
                <div class="col-md-1">
                    <div class="text-center">
                        <a href="../JgoBack.do"><button id="targetimage2" class="btn btn-primary" >后一张</button></a>
                    </div>
                </div>
            </div>
            <br><br>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <c:forEach var="page" items="${sessionScope.Jpages}" varStatus="status">
                                <c:choose>
